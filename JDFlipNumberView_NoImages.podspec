Pod::Spec.new do |s|
  ...
  s.name         = 'JDFlipNumberView w/o images'
  s.version      = '2.0.6'
  s.summary      = 'A simple, yet powerful, customizable FlipNumberView based on CoreAnimation (Simulating an analog flip display). This version comes without images, you need to provide your own.'
